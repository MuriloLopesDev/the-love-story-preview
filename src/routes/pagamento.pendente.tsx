...
export const Route = createFileRoute("/pagamento/pendente")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pagamento em análise pelo Mercado Pago." },
    ],
  }),
...
function PagamentoPendente() {
  return (
    <PaymentReturnCard
      ...
      text="Recebemos sua intenção de pagamento. Assim que o Mercado Pago confirmar, o presente será registrado."
